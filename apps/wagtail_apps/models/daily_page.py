...
from apps.wagtail_apps.models.content_page import CompanyDailyContentPage
...
class CompanyDailyPage(Page):
    ...
    def top_image(self):
        ...
        if top_image:
            private_context = {
                "banner_image": top_image.banner_image,
                "info": top_image.info,
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        context["companyinfo"] = CompanyInfo.objects.all().order_by("-id")[
            0
        ]  # 获取最新的一个公司信息对象
