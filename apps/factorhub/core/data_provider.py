...
class AKShareDataProvider:
    ...
    def get_stock_pool(self, pool_code: str = "hs300") -> List[str]:
        ...
        stock_pools = {
            "hs300": [
                "600000", "600016", "600019", "600028", "600030", "600036", "600048",
                "600050", "600051", "600060", "600064", "600066", "600067", "600069",
                "600073", "600078", "600079", "600084", "600085", "600089", "600094",
                "600095", "600096", "600097", "600098", "600099", "600100", "600101",
                "600104", "600105", "600106", "600107", "600108", "600110", "600111",
                "600112", "600114", "600115", "600116", "600118", "600119", "600120",
                "600122", "600123", "600125", "600126", "600127", "600128", "600129",
                "600130", "600131", "600132", "600133", "600135", "600136", "600137",
                "600138", "600139", "600141", "600142", "600143", "600145", "600146",
                "600147", "600148", "600149", "600150", "600151", "600152", "600153",
                "600154", "600155", "600156", "600157", "600158", "600159", "600160",
                "600161", "600162", "600163", "600165", "600166", "600167", "600168",
                "600169", "600170", "600171", "600172", "600173", "600175", "600176",
                "600177", "600178", "600179", "600180", "600181", "600182", "600183",
                "600184", "600185", "600186", "600187", "600188", "600189", "600190",
            ],
            "zz500": [
                ...
                "000036", "000037", "000038", "000039", "000040", "000041", "000042",
                "000043", "000044", "000045", "000046", "000047", "000048", "000049",
                "000050", "000051", "000052", "000053", "000054", "000055", "000056",
            ],
            "cyb": [
                "300001", "300002", "300003", "300004", "300005", "300006", "300007",
                "300008", "300009", "300010", "300011", "300012", "300013", "300014",
                "300015", "300016", "300017", "300018", "300019", "300020", "300021",
                "300022", "300023", "300024", "300025", "300026", "300027", "300028",
                "300029", "300030", "300031", "300032", "300033", "300034", "300035",
                "300036", "300037", "300038", "300039", "300040", "300041", "300042",
                "300043", "300044", "300045", "300046", "300047", "300048", "300049",
                "300050", "300051", "300052", "300053", "300054", "300055", "300056",
            ],
        }
    ...
    def get_daily_data(self,
                       ...
                       end_date: str,
                       adjust: str = "qfq",
                       network_requested: bool = False) -> pd.DataFrame:
        """
        获取单只股票历史数据
            ...
            if self.cache_enabled:
                ...
                if cached_df is not None and not cached_df.empty:
                    ...
                    if total_missing <= self.max_missing_days:
                        ...
                        result = cached_df[(cached_df['date'] >= start_dt) & (cached_df['date'] <= end_dt)]
                        return result.copy()
                    ...
                    if new_data_needed:
                        self.logger.debug(f"缓存部分命中 {symbol}: 缓存[{cache_start.date()}-{cache_end.date()}], 缺失{total_missing}天")
                        # 获取缺失的数据
                        ...
                        if not missing_df.empty:
                            ...
                            # 返回请求范围内的数据
                            result = merged_df[(merged_df['date'] >= start_dt) & (merged_df['date'] <= end_dt)]
                            return result
                    else:
                        # 缓存已覆盖全部范围
    ...
    def _fetch_and_process(self, symbol: str, start_date: str, end_date: str, adjust: str) -> pd.DataFrame:
        """获取并处理股票数据"""
        try:
