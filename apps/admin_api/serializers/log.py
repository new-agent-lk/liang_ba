...
class LogRotationConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'log_type', 'max_size_mb', 'max_files',
            'max_age_days', 'compress_old', 'enabled',
            'last_rotated', 'is_manually_paused', 'create_time'
        ]
...
class LogRotationStatusSerializer(serializers.Serializer):
    ...
    archived_files = serializers.ListField(
...
class LogViewerAccessLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user_id', 'username', 'action', 'log_type',
            'filters_applied', 'ip_address', 'user_agent', 'create_time'
        ]
