    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_type', models.CharField(choices=[('app', 'Application'), ('error', 'Error'), ('security', 'Security'), ('performance', 'Performance'), ('django', 'Django')], max_length=20, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_type', models.CharField(choices=[('app', 'Application'), ('error', 'Error'), ('security', 'Security'), ('performance', 'Performance'), ('django', 'Django')], db_index=True, max_length=20)),
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['log_type', '-timestamp'], name='system_log__log_typ_8f4db0_idx'), models.Index(fields=['trace_id', '-timestamp'], name='system_log__trace_i_50360b_idx'), models.Index(fields=['level', '-timestamp'], name='system_log__level_93e293_idx'), models.Index(fields=['user_id', '-timestamp'], name='system_log__user_id_3c9584_idx')],
            },
        ),
    ]
