    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "salary_min",
                    models.CharField(blank=True, max_length=20, verbose_name="最低薪资"),
                ),
                (
                    "salary_max",
                    models.CharField(blank=True, max_length=20, verbose_name="最高薪资"),
                ),
                (
                    "salary_display",
                    models.CharField(blank=True, max_length=50, verbose_name="薪资显示"),
                ),
                ...
                (
                    "experience",
                    models.CharField(blank=True, max_length=50, verbose_name="经验要求"),
                ),
                (
                    "education_required",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(blank=True, max_length=20, null=True, verbose_name="联系电话"),
                ),
                (
                    "avatar",
                    models.ImageField(
                ...
                (
                    "department",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="部门"),
                ),
                (
                    "position",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="职位"),
                ),
                (
                    "employee_id",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="员工ID"),
                ),
                (
                    "address",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="地址"),
                ),
                (
                    "city",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="城市"),
                ),
                (
                    "province",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="省份"),
                ),
                (
                    "postal_code",
                    models.CharField(blank=True, max_length=10, null=True, verbose_name="邮编"),
                ),
                (
                    "wechat",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="微信号"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company",
                    models.CharField(blank=True, max_length=100, verbose_name="公司/机构名称"),
                ),
