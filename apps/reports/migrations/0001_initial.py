    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "strategy_name",
                    models.CharField(blank=True, max_length=100, verbose_name="策略名称"),
                ),
                (
                    "strategy_type",
                    models.CharField(blank=True, max_length=50, verbose_name="策略类型"),
                ),
                ...
                (
                    "win_rate",
                    models.DecimalField(
                        blank=True, decimal_places=2, max_digits=10, null=True, verbose_name="胜率"
                    ),
                ),
                (
                    "profit_loss_ratio",
                ...
                (
                    "backtest_start_date",
                    models.DateField(blank=True, null=True, verbose_name="回测开始日期"),
                ),
                (
                    "backtest_end_date",
                    models.DateField(blank=True, null=True, verbose_name="回测结束日期"),
                ),
                (
                    "strategy_params",
                    models.JSONField(blank=True, default=dict, verbose_name="策略参数"),
                ),
                (
                    "equity_curve_image",
                    models.ImageField(
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to="reports/drawdown/%Y/%m/",
                        verbose_name="回撤图",
                    ),
                ),
                (
                ...
                (
                    "attachment",
                    models.FileField(
                        blank=True, null=True, upload_to="reports/files/%Y/%m/", verbose_name="附件"
                    ),
                ),
