...
from wagtail_app.models.content_page import CompanyContentPage
...
#         # 处理get请求的函数
#         try:
#             website_info = CompanyInfo.objects.all().order_by('-id')[0]  # 获取最新的一个公司信息对象
