...
class CompanyInfo(models.Model):
    ...
    logo = models.ImageField(verbose_name='logo', upload_to='website_info')  # 使用图片类型时，必需pillow依赖包
    ...
    qrcode = models.ImageField(verbose_name='微信二维码', upload_to='website_info')
    ...
    topimg = models.ImageField(verbose_name='非首页顶长图', upload_to='website_info')
