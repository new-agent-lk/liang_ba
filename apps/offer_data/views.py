...
from offer_data.crons import get_on_work_time
from offer_data.serializers.generic_stock_market_data import GenericStockMarketDataSerializer
...
class TenStockDataView(APIView):
    ...
    def get(self, request, date_flag):
        ...
        annual_yield, retreat_rate = count_rate(_data[code_flag]['stock_portfolio'])
        data['annual_yield'] = annual_yield
        data['retreat_rate'] = retreat_rate
