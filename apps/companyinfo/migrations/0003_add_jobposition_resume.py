    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('quant_dev', '量化开发'), ('data_engineer', '数据工程师'), ('risk_manager', '风控专员'), ('researcher', '研究员'), ('it_support', 'IT支持'), ('other', '其他')], default='other', max_length=50, verbose_name='岗位类别')),
                ('recruitment_type', models.CharField(choices=[('campus', '校园招聘'), ('social', '社会招聘')], default='social', max_length=20, verbose_name='招聘类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', '待查看'), ('viewed', '已查看'), ('interview', '待面试'), ('hired', '已录用'), ('rejected', '已拒绝'), ('withdrawn', '已撤回')], default='new', max_length=20, verbose_name='状态')),
                ...
                ('position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='companyinfo.jobposition', verbose_name='应聘岗位')),
            ],
            options={
                'verbose_name': '收到的简历',
