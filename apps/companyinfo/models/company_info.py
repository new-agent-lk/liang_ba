...
class CompanyInfo(models.Model):
    ...
    name = models.CharField(
        verbose_name="公司名称", max_length=50, default="北京源码商城有限公司"
    )  # 定义姓名字段，当前设置可在数据库相应的表中创建一个name字段，字符类型，长度为50
    logo = models.ImageField(
        verbose_name="logo", upload_to="companyinfo"
    )  # 使用图片类型时，必需pillow依赖包
    ...
    record_nums = models.CharField(
        verbose_name="备案号", max_length=50, default="京ICP备00000000号"
    )
