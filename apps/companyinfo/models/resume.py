...
from .choices import EDUCATION_CHOICES, JOB_CATEGORY_CHOICES
...
class Resume(models.Model):
    ...
    position = models.ForeignKey(
        JobPosition, on_delete=models.SET_NULL, null=True, verbose_name="应聘岗位"
    )
    job_category = models.CharField(
        "应聘职位类别", max_length=50, choices=JOB_CATEGORY_CHOICES, default="other"
    )
    expected_salary = models.CharField("期望薪资", max_length=50, blank=True)

    # 教育信息
    education = models.CharField("最高学历", max_length=20, choices=EDUCATION_CHOICES, blank=True)
    ...
    # 简历文件
    resume_file = models.FileField("简历文件", upload_to="resumes/%Y/%m/", null=True, blank=True)
