...
from typing import Generator, Dict, Any, Optional, Iterator, Union, Tuple
...
class ParsedLogEntry:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], raw_line: str = '', file_path: Path = None) -> 'ParsedLogEntry':
...
class LogParser:
    ...
    def list_available_logs(cls) -> Dict[str, Path]:
        ...
        return {
            name: path for name, path in cls.LOG_FILES.items()
            if path.exists()
        }
