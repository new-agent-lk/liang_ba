...
import { Modal, Form, Input, Switch, Button, message, Popconfirm, Tabs, Select } from 'antd';
import { DeleteOutlined } from '@ant-design/icons';
import PageHeader from '@/components/Common/PageHeader';
import DataTable from '@/components/Common/DataTable';
import { useTable } from '@/hooks/useTable';
import { getUsers, createUser, updateUser, deleteUser } from '@/api/users';
import { User, DEPARTMENT_CHOICES, POSITION_CHOICES, GENDER_CHOICES } from '@/types';
  ...
  const handleEdit = (record: User) => {
    ...
    if (record.profile) {
      profileForm.setFieldsValue({
        ...
        birthday: record.profile.birthday ? new Date(record.profile.birthday) : null,
        ...
        <Tabs defaultActiveKey="basic" onChange={() => {}}>
          <TabPane tab="基本信息" key="basic">
            <Form
              form={form}
              layout="vertical"
              initialValues={{ is_staff: false, is_superuser: true, is_active: true }}
            >
